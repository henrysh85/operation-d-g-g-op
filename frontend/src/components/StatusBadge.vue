...
const map: Record<string, string> = {
  ...
  responded: 'bg-emerald-50 text-ok border-emerald-200',
...
<template>
  <span class="inline-flex items-center gap-1 text-xxs px-1.5 py-0.5 rounded border font-medium capitalize"
        :class="cls">
